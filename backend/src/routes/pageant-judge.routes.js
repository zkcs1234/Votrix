...
router.post('/events/:eventId/score', requireEventParticipant(PARTICIPANT_TYPES.COMPETITION_JUDGE), scoreLimiters.ip, scoreLimiters.user, ctrl.submitScores)
...
router.post('/events/:eventId/session-score', requireEventParticipant(PARTICIPANT_TYPES.COMPETITION_JUDGE), scoreLimiters.ip, scoreLimiters.user, sessionCtrl.submitJudgeSessionScore)
